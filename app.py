...
Auth = str(os.getenv("Authorization", "Failed getting auth"))
ClientID = str(os.getenv("CW_ClientID", "Failed getting client id"))
TENANT_ID = str(os.getenv("tenant_id", "Failed getting tenant id"))
CLIENT_ID = str(os.getenv("client_id", "Failed getting client id"))
CLIENT_SECRET = str(os.getenv("client_secret", "Failed getting client secret"))
TEAM_ID = str(os.getenv("team_id", "Failed getting team id"))
CHANNEL_ID = str(os.getenv("channel_id", "Failed getting channel id"))
CHAT_ID = str(os.getenv("chat_id", "19:"))
SENDER_USER_ID = str(os.getenv("sender_user_id", "Failed getting sender user id"))
SENDER_DISPLAY_NAME = str(os.getenv("sender_display_name", "Failed getting sender display name"))

SMTP_SERVER = str(os.getenv("smtp_server", "outbound-us1.ppe-hosted.com"))
SMTP_PORT = int(os.getenv("smtp_port", 587))
SMTP_SENDER_EMAIL = str(os.getenv("smtp_sender_email"))
SMTP_USER = str(os.getenv("smtp_auth_user"))
SENDER_PASSWORD = str(os.getenv("smtp_auth_password"))
RECIPIENT_EMAILS = os.getenv("recipient_emails", "").split(",") 


QR_QUEUE = str(os.getenv("QR_QUEUE", "15"))
QR_START_HOUR = int(os.getenv("QR_START_HOUR", 7))
QR_END_HOUR = int(os.getenv("QR_END_HOUR", 18))
